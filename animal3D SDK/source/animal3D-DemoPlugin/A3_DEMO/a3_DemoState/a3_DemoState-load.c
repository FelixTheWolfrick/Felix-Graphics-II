...
void a3demo_loadFramebuffers(a3_DemoState* demoState)
{
	...
	fbo = demoState->fbo_d32; // Shadow Map
	...
	a3framebufferCreate(fbo, "fbo:c16;szHalf" + 1,
		1, a3fbo_colorRGBA16, a3fbo_depthDisable,
		frameWidth2, frameHeight2);

	fbo = demoState->fbo_c16_szHalf + 2;
	a3framebufferCreate(fbo, "fbo:c16;szHalf" + 2,
		1, a3fbo_colorRGBA16, a3fbo_depthDisable,
		frameWidth2, frameHeight2);
	...
	a3framebufferCreate(fbo, "fbo:c16;szQuarter" + 1,
		1, a3fbo_colorRGBA16, a3fbo_depthDisable,
		frameWidth4, frameHeight4);

	fbo = demoState->fbo_c16_szQuarter + 2;
	a3framebufferCreate(fbo, "fbo:c16;szQuarter" + 2,
		1, a3fbo_colorRGBA16, a3fbo_depthDisable,
		frameWidth4, frameHeight4);
	...
	a3framebufferCreate(fbo, "fbo:c16;szEighth" + 1,
		1, a3fbo_colorRGBA16, a3fbo_depthDisable,
		frameWidth8, frameHeight8);

	fbo = demoState->fbo_c16_szEighth + 2;
	a3framebufferCreate(fbo, "fbo:c16;szEighth" + 2,
		1, a3fbo_colorRGBA16, a3fbo_depthDisable,
		frameWidth8, frameHeight8);
